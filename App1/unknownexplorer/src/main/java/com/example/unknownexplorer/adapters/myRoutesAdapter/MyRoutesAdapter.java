...
public class MyRoutesAdapter extends RecyclerView.Adapter<MyRoutesAdapter.MyRoutesViewHolder> {
    ...
    static class MyRoutesViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyRoutesViewHolder(View itemView) {
            ...
            routerPick = itemView.findViewById(R.id.image_pic_router_my_routes);
            routeSetting = itemView.findViewById(R.id.image_route_setting);
            itemView.findViewById(R.id.image_route_setting).setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        public void bind(Route route) {
            ...
            routerPick.setImageResource(R.drawable.ic_menu_camera);
            routeSetting.setImageResource(R.drawable.ic_menu_slideshow);
        }
    }
}
